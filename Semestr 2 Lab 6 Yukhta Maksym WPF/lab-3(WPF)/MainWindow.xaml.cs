...
namespace lab_3_WPF_
{
    public partial class MainWindow : Window
    {
        ...
        private readonly string PRESS_OK_MESSAGE = "Натисніть клавішу \"Ок\"!";
        private readonly string NOT_PRESS_OK_MESSAGE = "Клаіша \"Ок\" не може бути нажатою";
        private readonly string MESSAGE_BOX_TITLE = "Майстер";
        private readonly string MESSAGE_BOX_TEXT = "Зловив!";
